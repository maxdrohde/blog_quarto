...
This function takes in a real valued input and transforms it to lie within $[0,1]$. THe expit function is also called the logistic function, hence the name "logistic regression".
